...
const techSection = document.querySelector(".technology__section");
const cta = document.querySelector(".cta__section");
const film = document.querySelector(".film__section");
window.onscroll = () => {
  const topTechSection = techSection.getBoundingClientRect().top;
  const bottomTechSection = techSection.getBoundingClientRect().bottom;
  ...
  contactLinks.forEach((contact) => {
    ...
    if (
      (topTechSection < topContactLink + 10 &&
        bottomTechSection > topContactLink) ||
...
/* ====================================================
   Changing The Cursor When Hovering Over The Technology Section 
  ===================================================== */
