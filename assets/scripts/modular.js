...
/* ====================================================
   Managing The Sort Content
  ===================================================== */
const sortContent = document.querySelector(".sort__content");
const sortItems = document.querySelector(".sort__items");
const sortItemsTitle = document.querySelectorAll(".sort__items > span");
const btnSort = document.querySelector(".sort__button");
const splideSlides = document.querySelectorAll(
  ".splide__wrapper .splide__slide__row .splide__slide"
);
sortContent.addEventListener("click", () => {
  sortItems.classList.toggle("active");
});
btnSort.addEventListener("click", () => {
  sortItems.classList.toggle("active");
});
sortItemsTitle.forEach((title) => {
  title.addEventListener("click", () => {
    sortContent.querySelector(".title").innerHTML = title.textContent;
    sortItems.classList.remove("active");
    const sortValue = title.getAttribute("data-value");
    splideSlides.forEach((splide) => {
      if (splide.getAttribute("data-sort") !== sortValue) {
...
window.onclick = (e) => {
  if (
    ...
    e.target.className !== "sort__content" &&
