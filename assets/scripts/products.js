...
const ctaTwo = document.querySelector(".cta__one_section");
window.onscroll = () => {
...
/* ====================================================
  ...
  ===================================================== */
const productItemImgs = document.querySelectorAll(
  ".products__item_img_wrapper"
);
productItemImgs.forEach((product) => {
  product.addEventListener("mousemove", (e) => {
    ...
    const cursorCustome = product.querySelector(".product__view");
  ...
  product.addEventListener("mouseout", () => {
    const courserCustome = product.querySelector(".product__view");
